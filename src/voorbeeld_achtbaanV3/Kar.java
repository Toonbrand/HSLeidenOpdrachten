...
public class Kar extends JPanel
{
	...
	public void voegPersoonToe(Persoon persoon)
	{
		...
		{
			System.out.println("Helaas, persoon " + persoon.getNaam() + " is te lang.");
			return;
		}
		
		if(persoon.getLengte() < MIN_LENGTE)
		{
			System.out.println("Helaas, persoon " + persoon.getNaam() + " is te kort.");
			return;
		}
		
		if(personen.size() == MAX_PERSONEN)
		{
			System.out.println("Helaas, het karretje is vol.");
			return;
		}
		
		if(isKarTeZwaar(persoon))
		{
			System.out.println("Helaas, het karretje is te zwaar.");
			return;
		}
