...
public class PacmanPaneel extends JPanel implements ActionListener
{
	...
	{
		raster = new Raster();
		pacman = new Pacman(500,500,50,0,5,Color.YELLOW);
		spook1 = new Spook(100,100,50,0,5,Color.RED);
		spook2 = new Spook(100,100,50,5,0,Color.BLUE);
		spook3 = new Spook(100,100,50,0,-5,Color.ORANGE);
		spook4 = new Spook(100,100,50,-5, 0,Color.PINK);
